...
export default function RegisterScreen() {
  ...
  return (
    <div className="flex flex-1 flex-col bg-white px-6 pb-10 pt-8">
      <Logo size={40} />
      <div className="mt-6">
        <h1 className="text-2xl font-extrabold tracking-tight text-brand-900">Create your account</h1>
      ...
      <form onSubmit={submit} className="mt-6 space-y-4">
        ...
        <Field label="NRC / passport number">
          <TextInput placeholder="e.g. 327145/61/1" value={form.nrcOrPassport} onChange={set("nrcOrPassport")} />
        </Field>
        ...
        <div className="flex items-start gap-2 rounded-xl bg-brand-50/60 px-3 py-2.5 text-[11px] text-slate-500">
          <CheckCircle2 size={15} className="mt-0.5 shrink-0 text-brand-500" />
          By registering you agree to assign collection of public performance and
          mechanical royalties to ZAMCOPS under the Copyright Act of Zambia.
        </div>
