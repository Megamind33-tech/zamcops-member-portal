      ...
      <div className="card relative z-10 flex flex-1 flex-col px-5 py-6">
        ...
        {sent ? (
          <div className="mt-12 flex flex-1 flex-col items-center justify-center text-center">
            <div className="grid h-16 w-16 place-items-center rounded-[1.25rem] bg-emerald-50 text-emerald-600 ring-1 ring-emerald-100">
              <MailCheck size={32} />
            </div>
            <h1 className="mt-4 font-display text-2xl font-semibold tracking-tight text-brand-900">
              Check your inbox
            </h1>
          ...
          <>
            <div className="mt-8">
              <p className="text-[10px] font-bold uppercase tracking-[0.28em] text-gold-600">Account recovery</p>
