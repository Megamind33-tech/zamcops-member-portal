  ...
  return (
    <>
      ...
      <p className="mt-1 text-sm text-zam-muted">
        Enter the phone or email linked to your membership. The ZAMCOPS team will verify your identity and issue you a
        temporary password.
      </p>

      <form onSubmit={submit} className="mt-6 space-y-4">
        <Field label="Phone or email" required>
          <Input placeholder="you@email.com or +260…" value={contact} onChange={(e) => setContact(e.target.value)} />
        </Field>
